...
window.addEventListener('DOMContentLoaded', (e) => {
    for (let i = 0; i < allKeywords.length; i++) {
        ...
        btn.addEventListener('click', function (e) {
            ...
            else if (e.target.classList.contains('backspace') ||e.target.classList.contains('Backspace') || e.target.classList.contains('BACKSPACE')) {
            ...
            else if (e.target.classList.contains('space') || e.target.classList.contains('SPACE') || e.target.classList.contains('Space')) {
                inputBoxValue.value += " "
            }
            else {
